...
public class UpdateMailConfigurationCommandRequestValidator : AbstractValidator<UpdateMailConfigurationCommandRequest>
{
    public UpdateMailConfigurationCommandRequestValidator()
    {
