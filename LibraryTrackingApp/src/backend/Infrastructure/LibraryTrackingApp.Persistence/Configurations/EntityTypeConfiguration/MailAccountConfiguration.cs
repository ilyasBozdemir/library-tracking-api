...
public class MailAccountConfiguration : IEntityTypeConfiguration<Domain.Entities.Configuration.MailAccountConfiguration>
{
    public void Configure(EntityTypeBuilder<Domain.Entities.Configuration.MailAccountConfiguration> builder)
    {
