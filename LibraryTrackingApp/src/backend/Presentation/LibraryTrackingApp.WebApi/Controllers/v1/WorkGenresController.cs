...
using LibraryTrackingApp.Application.Features.WorkGenres.Queries.Requests;
using LibraryTrackingApp.Application.Features.WorkGenres.Commands.Requests;
using LibraryTrackingApp.Application.Features.WorkGenres.Events;
...
public class WorkGenresController : CustomBaseController
{
    public WorkGenresController(IMediator mediator) : base(mediator)
    {
    }
