...
import { RiUserStarLine, RiUserSharedLine, RiBookLine } from 'react-icons/ri';
...
const data = [
  ...
  {
    id: 2,
    label: 'Toplam Ödünç Verilen Kitap Sayısı',
    score: 150,
    icon: RiBookLine,
    percentage: '30%'
  },
  {
    id: 3,
    label: 'Toplam Kayıtlı Kullanıcı Sayısı',
    score: 500,
    icon: RiUserStarLine,
    percentage: '15%'
  },
  {
    id: 4,
    label: 'Toplam Aktif Kullanıcı Sayısı',
    score: 200,
