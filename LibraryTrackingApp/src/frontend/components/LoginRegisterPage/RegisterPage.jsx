...
const RegisterPage = () => {
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      email: Yup.string().email('Geçerli bir e-posta adresi girin').required('E-posta zorunlu'),
      phone: Yup.string().matches(/^\d{10}$/, 'Geçerli bir telefon numarası girin').required('Telefon zorunlu'),
  ...
  return (
    <form onSubmit={formik.handleSubmit}>
      ...
      <FormControl id="lastName" mt={4} isInvalid={formik.touched.lastName && formik.errors.lastName}>
      ...
      <FormControl id="phone" mt={4} isInvalid={formik.touched.phone && formik.errors.phone}>
      ...
      <Button type="submit" colorScheme="blue" mt={4}>Kayıt Ol</Button>
    </form>
  );
};
